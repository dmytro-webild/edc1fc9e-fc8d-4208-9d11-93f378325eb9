...
import { Car, Clock, DollarSign, MapPin, ShieldCheck, Utensils, Wallet } from "lucide-react";
...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      buttons={[
        {
          text: "Call Now (+91 96792 11094)",
          href: "tel:+919679211094",
        },
        {
          text: "View Menu",
          href: "#menu",
      ...
      avatars={[
        {
          src: "http://img.b2bpic.net/free-photo/cartoon-style-shawarma-sauce_23-2150250198.jpg",
          alt: "Happy regular customer",
        },
        {
          src: "http://img.b2bpic.net/free-photo/cheese-sticks-with-ketchup-mayonnaise-glass-lemonade_114579-3372.jpg",
          alt: "Satisfied diner",
        },
        {
          src: "http://img.b2bpic.net/free-photo/side-view-chicken-doner-wrapped-lavash-lettuce-wooden-table_140725-11887.jpg",
          alt: "Group at restaurant",
        },
        {
          src: "http://img.b2bpic.net/free-photo/salmon-wrap-sandwich-roll-with-cheese-vegetables-black-stone-background_123827-21138.jpg",
  ...
  <div id="menu" data-section="menu">
      ...
      products={[
        ...
        },
        {
          ...
          price: "₹100",
          variant: "Noodles",
          imageSrc: "http://img.b2bpic.net/free-photo/front-view-delicious-vegetable-salad-inside-tray-grey-table_140725-131697.jpg",
        },
        {
          id: "3",
          name: "Chicken Tikka",
        ...
        },
        {
          ...
          price: "₹45",
          variant: "Soups",
          imageSrc: "http://img.b2bpic.net/free-photo/top-view-fresh-delicious-chinese-food-dark-background_24972-2162.jpg",
        },
        {
          id: "6",
          name: "Egg Maggi",
          price: "₹50",
          variant: "Maggi",
          imageSrc: "http://img.b2bpic.net/free-photo/bottom-view-asian-ramen-noodles-with-coriander-bowl-chopsticks-dark-table_140725-146272.jpg",
        },
      ]}
      title="Our Menu"
  ...
  <div id="features" data-section="features">
      ...
      features={[
        ...
        },
        {
          ...
          description: "Great taste at budget-friendly rates.",
        },
        {
          icon: Utensils,
          title: "Dine-in Available",
          description: "Comfortable seating for you and family.",
        },
        {
          icon: Car,
          title: "Drive-through",
          description: "Quick pick up for your convenience.",
        },
        {
          icon: ShieldCheck,
          title: "No-contact Delivery",
          description: "Safety prioritized in every order.",
        },
      ]}
